  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 className="text-slate-900">Backup & Recovery</h1>
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        <div className="rounded-2xl border border-slate-200 bg-white p-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-slate-900">Export / Backup</p>
      ...
      <div className="rounded-2xl border border-slate-200 bg-white p-6">
        <h2 className="text-slate-900">Manual Commands</h2>
        <p className="mt-1 text-xs text-slate-500">
          Run these in a local terminal on the machine hosting MySQL.
        </p>
        <div className="mt-4 grid gap-4 lg:grid-cols-2">
          <div>
            <p className="text-sm text-slate-700">Export / Backup (mysqldump)</p>
...
+mysql -u root -p ccms_db &lt; backup_ccms_db.sql
          ...
          <div>
            <p className="text-sm text-slate-700">Export to a custom file name</p>
            <pre className="mt-2 rounded-lg border border-slate-200 bg-slate-50 p-3 text-xs text-slate-700">
